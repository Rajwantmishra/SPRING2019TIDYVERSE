...
## Rajwant Part2 Start: 
### Working with forcats package 

This package give some tool tool to work with Categorical Variables
Count entries in a factor, similar to table or group_by with summareise .
 Here I am using `fct_count` , `group_by` and `table` to get the count of factor variable.
